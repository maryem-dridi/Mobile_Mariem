...
public class ListeReclamation extends BaseForm{
    ...
    public ListeReclamation(Resources res){
        ...
        super("ListeReclamation",BoxLayout.y());
        
        Toolbar tb = new Toolbar(true);
        current = this;
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("ListeReclamation");
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Liste Reclamation", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Liste Reclamation", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&display=popup&ref=plugin&src=share_button");
        ...
        ArrayList<Recamation>list = Service_Reclamation.getInstance().findAll();
        
        for(Recamation art:list){
    ...
    private void addButton(Image img, Recamation art,Resources res) {
        ...
        Container cnt = BorderLayout.west(image);
                ...
                Label dateTxt = new Label("Message : "+art.getMessage(),"NewsTopLine2");

                
                  Label titreTxt2 = new Label("Type : "+art.getType(),"NewsTopLine2");

                 Label titreTxt = new Label("Statut : "+art.getStatut(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette reclamation ?","Annuler","Oui")){
                ...
                if(Service_Reclamation.getInstance().deleteReclamation(art.getIdreclamation())){
                    new ListeReclamation(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
        new ModifierReclamation(res, art).show();
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY(
                ...
                BoxLayout.encloseX(lSupprimer,lQrCode,lModifier)
