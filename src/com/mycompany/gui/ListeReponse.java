 ...
 * @author youss
 */
public class ListeReponse extends BaseForm{
    Form current;

    public ListeReponse(Resources res){
        
        super("Liste Reponse",BoxLayout.y());
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Reponses", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Partager", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Reponses", barGroup);
...
Button Share=new Button("Share");
 ...
 liste.addPointerPressedListener(l->{
     Display.getInstance().execute("https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=http%3A%2F%2F127.0.0.1%3A8000%2Fequipe_mobile&");
 });
        ...
        ArrayList<Reponse>list = Service_Reponse.getInstance().findAll();
        
        for(Reponse art:list){
    ...
    private void addButton(Image img, Reponse art,Resources res) {
        ...
        Label titreTxt = new Label("Message : "+art.getMessageRep(),"NewsTopLine2");
        
            Label titreTxt2 = new Label("date Reponse : "+art.getDateRep(),"NewsTopLine2");

                  Label titreTxt3 = new Label("Id Reponse "+art.getIdReponse(),"NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette reponse ?","Annuler","Oui")){
                ...
                if(Service_Reponse.getInstance().deleteReponse(art.getIdReponse())){
                    new ListeReponse(res).show();
        ...
        lModifier.addPointerPressedListener(l ->{
            System.out.println("");
       new ModifierReponse(res, art).show();
