...
public class ModifierReponse extends BaseForm{
    ...
    public ModifierReponse(Resources res, Reponse rec) {
...
tb.addSearchCommand(e -> {
        ...
        TextField Nom = new TextField(rec.getMessageRep(), "Message", 20, TextField.ANY);
        ...
        btnModifier.addPointerPressedListener(l -> {
          rec.setMessageRep(Nom.getText());



            if (Service_Reponse.getInstance().ModifierReponse(rec)) {
