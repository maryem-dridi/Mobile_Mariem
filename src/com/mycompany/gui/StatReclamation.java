...
public class StatReclamation {
     ...
     */
    protected CategorySeries buildCategoryDataset(String title, ArrayList<Recamation> ab) {
        CategorySeries series = new CategorySeries(title);

        for (Recamation u : ab) {
            series.add(u.getMessage(), u.getIdreclamation());
    ...
    public void createPieChartForm(String titre, ArrayList<Recamation> ab,Resources res) {
        // Generate the values
